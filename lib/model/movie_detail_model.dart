...
class MovieDetailModel {
  ...
  factory MovieDetailModel.fromJson(Map<String, dynamic> json) => MovieDetailModel(
    ...
    belongsToCollection: BelongsToCollection.fromJson(json["belongs_to_collection"]?? null),
    budget: json["budget"],
...
class ProductionCompany {
  ...
  factory ProductionCompany.fromJson(Map<String, dynamic>? json) => ProductionCompany(
    id: json != null ? json["id"] : 0,
    logoPath: json != null ? json["logo_path"]  : "",
    name: json != null ? json["name"] : "",
    originCountry: json != null ? json["origin_country"] : "",
  );
